...
con encriptacion (AES-256-GCM), que es el mismo estándar de 
encriptación de grado militar, hoy en día no existe ninguna
computadora en el mundo capaz de "romper" AES-256 por fuerza bruta.

NOTA:
La contraseña maestra no se puede recuperar por temas de seguridad,
